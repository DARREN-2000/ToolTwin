          ...
          <div onClick={(e) => e.stopPropagation()} className="w-full max-w-xl mx-4">
            <Command className="bg-muted border border-border rounded-xl shadow-2xl overflow-hidden flex flex-col">
              ...
              <Command.List className="max-h-[60vh] overflow-y-auto p-2">
                <Command.Empty className="p-6 text-center text-sm text-foreground/50">No results found.</Command.Empty>
                
                <Command.Group heading={<div className="px-3 py-2 text-xs font-semibold text-foreground/50 uppercase tracking-wider">Navigation</div>}>
                ...
                <Command.Group heading={<div className="px-3 py-2 text-xs font-semibold text-foreground/50 uppercase tracking-wider mt-4">AI Actions</div>}>
                  <Command.Item 
                    onSelect={() => { 
      ...
      <aside className="w-64 bg-muted/50 border-r border-border flex flex-col shrink-0 relative">
        ...
        <div className="px-4 py-3 border-b border-border">
           ...
           >
             ...
             <span className="text-xs bg-muted px-1.5 py-0.5 rounded font-mono">⌘K</span>
           </button>
        </div>
