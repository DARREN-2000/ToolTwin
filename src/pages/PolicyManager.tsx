  ...
  const policies = [
    {
      ...
      description:
        "Preserve customer records for 7 years after last activity or if historical orders exist",
      type: "retention",
      severity: "CRITICAL",
      active: true,
    },
          ...
          >
            <div className="space-y-1">
              <div className="flex items-center gap-3">
                ...
                <span
                  className={`px-2.5 py-0.5 rounded-full text-xs font-bold border ${policy.severity === "CRITICAL" ? "bg-destructive/15 text-destructive border-destructive/30" : "bg-yellow-400/15 text-yellow-400 border-yellow-400/30"}`}
                >
                  {policy.severity}
                </span>
              </div>
