...
export default function ToolCatalog() {
  const tools = [
    ...
    },
    {
      ...
      description:
        "Anonymizes customer PII but preserves transactional history.",
      destructive: false,
      params: '{"customer_id": "string"}',
      dependencies: [],
    },
    ...
    <div className="p-8 max-w-5xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-foreground/60 mt-1">
          Available actions the AI agent can propose.
        </p>
      </div>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-1">
                    {tool.dependencies.map((dep) => (
                      <span
                        key={dep}
                        className="bg-secondary/50 text-foreground px-2 py-1 rounded text-xs border border-border/50"
                      >
                        {dep}
                      </span>
                    ))}
