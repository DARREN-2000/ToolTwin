...
export default function ReviewQueue() {
  ...
  return (
    <div className="p-4 md:p-8 max-w-5xl mx-auto space-y-6">
      <div>
        <h1 className="text-3xl font-heading font-bold text-foreground">Review Queue</h1>
        <p className="text-foreground/60 mt-1">Actions awaiting human approval.</p>
      </div>
      ...
      <div className="bg-muted/30 border border-border rounded-xl divide-y divide-border overflow-hidden">
        ...
        <div className="p-4 md:p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 hover:bg-muted/50 transition-colors">
          <div className="space-y-1">
            <div className="flex items-center gap-3">
              <h3 className="font-bold text-lg text-foreground font-mono break-all">delete_customer</h3>
            ...
            <p className="text-sm text-foreground/70 break-all">Params: {`{"customer_id": "CUS-10482"}`}</p>
            <p className="text-xs text-foreground/50 mt-2">Proposed by Operator • 10 minutes ago</p>
          </div>
        ...
        <div className="p-4 md:p-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 hover:bg-muted/50 transition-colors opacity-70">
          <div className="space-y-1">
            <div className="flex items-center gap-3">
              <h3 className="font-bold text-lg text-foreground font-mono break-all">issue_refund</h3>
              <span className="badge-risk-low px-2.5 py-0.5 rounded-full text-xs font-bold shrink-0">
                LOW RISK
              </span>
            </div>
            <p className="text-sm text-foreground/70 break-all">Params: {`{"order_id": "ORD-0501", "amount": 50.00}`}</p>
            <p className="text-xs text-foreground/50 mt-2">Proposed by Operator • 1 hour ago</p>
          </div>
